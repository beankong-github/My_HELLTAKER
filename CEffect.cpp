	...
	: m_wstrCurEffect()
{
	...
	//// 성공 효과
	//pAnimator->CreateAnimation(L"success_effect", L"texture\\animation\\effect\\success_effect\\", 0.1f, 15);
	...
	pAnimator->LoadAnimation(L"animation\\effect\\vfx_1.anim");
	pAnimator->LoadAnimation(L"animation\\effect\\vfx_2.anim");

	pAnimator->LoadAnimation(L"animation\\effect\\success_effect.anim");
